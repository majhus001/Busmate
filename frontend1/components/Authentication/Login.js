...
const [city ,setCity] = useState("summa");
const [state , setState] = useState("summa");
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.radioContainer}>
        {["Admin", "User", "Conductor"].map((item) => (
          <TouchableOpacity key={item} style={styles.radioButton} onPress={() => setRole(item)}>
