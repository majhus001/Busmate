...
const Signup = ({ navigation }) => {
 ...
 const [city,setCity] = useState("");
  ...
  const handleSignup = async () => {
    ...
    console.log("Signup Data:", { Username, email, password, role , city , state });
...
<TextInput
      ...
      <View style={styles.radioContainer}>
        <TouchableOpacity style={styles.radioButton} onPress={() => setRole("Admin")}>
          <View style={[styles.circle, role === "Admin" && styles.selected]} />
          <Text style={styles.radioText}>Admin</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.radioButton} onPress={() => setRole("User")}>
          <View style={[styles.circle, role === "User" && styles.selected]} />
